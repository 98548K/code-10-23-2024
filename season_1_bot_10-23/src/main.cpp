...
digital_out elevated_intake = digital_out(Brain.ThreeWirePort.E);
  ...
  while(true) {
    if(RemoteControlCodeEnabled) {
      ...
      if (Controller1.ButtonR1.pressing()) {
        while (claw_tracking.position(degrees) <= 60) {
